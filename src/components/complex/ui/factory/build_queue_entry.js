...
const BuildQueueEntry = (props) => <div className="tile is-parent has-text-centered is-marginless is-paddingless" key={props.index}>
	<div style={{marginLeft:'.7rem !important'}}
	...
	<div className="tile is-child is-2 is-marginless is-paddingless is-size-7">
		<a onClick={() => props.onCancelMachineFromBuildQueue(props.entry, props.index)} className="tooltip is-tooltip-left"
			data-tooltip={'Refunds ' + props.buildingGetCancellationRefundAmount(props.entry.cost) + ' of ' + props.entry.cost + ' Favours'}>
