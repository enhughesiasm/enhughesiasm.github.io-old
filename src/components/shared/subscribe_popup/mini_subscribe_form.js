...
export default class MiniSubscribeForm extends React.Component {
	...
	render(){
		const gdprConsentText = 'I agree to my personal data being stored and used to send me email.';
		return(<div className="has-text-centered is-size-6 is-size-7-mobile">
			<form id="miniMailchimpForm" name="mc-embedded-subscribe-form" target="_blank" onSubmit={this.props.handleSubmit}>
				<p className="" style={{padding: '.75rem 0', fontSize: '90%'}}>... but I&apos;d like to send you <strong>occasional entertaining stories</strong> about life, anxiety & things.</p>
				<fieldset>
					...
					<div className="field">
						<label htmlFor="mini_gdpr_1917" className="is-size-7">
							<input type="checkbox" id="mini_gdpr_1917" name="gdpr[1917]"
								value='Y'
					...
					<div className="field has-text-centered">
						<input type="submit" readOnly disabled={!this.isEnabled()} value="Entertain me occasionally!" name="subscribe" id="mc-embedded-subscribe" className={'button is-rounded ' + (this.isEnabled() ? 'is-success' : 'is-danger')} />
					</div>

				</fieldset>
				<p className="smallPrint is-size-7" style={{ margin: '1.1rem 0 0'}}>Mailchimp is my email list management platform. By clicking above, you acknowledge that your information will be processed according to <a href="/privacy" target="_blank" rel='noopener noreferrer'>these terms</a>, and transferred to Mailchimp for processing. <a href="https://mailchimp.com/legal/"  rel="noopener noreferrer">Learn more about Mailchimp here.</a></p>
