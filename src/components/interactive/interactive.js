	...
	return (<div>
		...
		<div className="content">
			...
			<ul className="list" style={{listStyle:'none'}}>
				<li className="list-item has-text-info is-flex" style={{alignItems:'center'}}><strong><Link to="/complex"><div className="button is-success">The Supplier&apos;s Complex</div></Link></strong>
					<span style={{marginLeft:'1rem'}}>Create magical jars of human traits to supply <Link to="/sbl">The Shop Before Life</Link>
					</span>
				</li>
